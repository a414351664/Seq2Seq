...
# English source data
# train_src = os.path.join("data","small_vocab_en")
train_src = 'train.src'
train_tgt = 'train.tgt'
vocab_src = 'fra2eng/src_vocab_file'
vocab_tgt = 'fra2eng/tgt_vocab_file'
...
with open(vocab_src, 'w', encoding='utf-8') as f:
    for word in SOURCE_CODES + source_vocab:
        f.write(word)
        f.write('\n')
with open(vocab_tgt, 'w', encoding='utf-8') as f:
    for word in TARGET_CODES + target_vocab:
        f.write(word)
        f.write('\n')
